...
class Room:
    ...
    async def add_client(self, client_id, name, websocket):
        ...
        hint_response = { "hint": self.current_hints, "countries": countries }
    ...
    async def receive_guess(self, client_id, guess):
        ...
        guesses_left = len([c.guess for c in self.clients.values() if c.guess == None])
    ...
    def send_message(self, client_id, message):
        self.clients[client_id].socket.send_json(message)
